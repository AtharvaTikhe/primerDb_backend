...
class GenerateP3Input:
    def __init__(self, chr, coord, flanks, seq_id, target, num_ret):
        ...
        self.p3_input_file = f"{cache_path}/{self.seq_id}.input.txt"
        self.p3_output = f"{output_path}/{self.seq_id}_out.txt"
...
if __name__=="__main__":
    obj = GenerateP3Input('chr13', '20189511', '1000', 'CHR13', '900,200', '10')
    print(obj.run_primer3())